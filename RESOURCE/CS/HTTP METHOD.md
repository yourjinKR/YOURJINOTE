...
HTTP 메서드는 클라이언트가 서버에게 "이 리소스에 대해 어떤 동작을 할 것인지"를 알려주는 약속입니다. 이를 목적에 맞게 사용하는 것이 [RESTful한 API](RESTful%20API.md) 설계의 핵심입니다.
...
자세한 내용은 [해당 글](https://developer.mozilla.org/ko/docs/Web/HTTP/Reference/Methods)을 참고
