...
[Kotlin-High-order-Function](../../RESOURCE/KOTLIN/Kotlin-High-order-Function.md)
```kotlin
// 26세 이하만 필터링
...
# 도움이 됐던 자료
[](https://adjh54.tistory.com/610#1)
[함수형 프로그래밍이란??? (feat. kotlin)](feat.%20kotlin))
...
[](https://tech.kakaopay.com/post/way-to-functional-programming/#4-이미-잘-만들어져-있는-라이브러리kotlin-arrow-활용)
